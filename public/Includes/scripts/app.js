...
var _libJquery1112Min = require('./lib/jquery-1.11.2.min');

var _libJquery1112Min2 = _interopRequireDefault(_libJquery1112Min);

var _modulesUtilsEs6 = require('./modules/Utils.es6');

var _modulesUtilsEs62 = _interopRequireDefault(_modulesUtilsEs6);

var _modulesMainEs6 = require('./modules/Main.es6');

var _modulesMainEs62 = _interopRequireDefault(_modulesMainEs6);

var _modulesLoginEs6 = require('./modules/Login.es6');

var _modulesLoginEs62 = _interopRequireDefault(_modulesLoginEs6);

var _modulesAccountDetailsEs6 = require('./modules/AccountDetails.es6');

var _modulesAccountDetailsEs62 = _interopRequireDefault(_modulesAccountDetailsEs6);

var _modulesLocationDetailsEs6 = require('./modules/LocationDetails.es6');

var _modulesLocationDetailsEs62 = _interopRequireDefault(_modulesLocationDetailsEs6);

var _modulesDeviceDetailsEs6 = require('./modules/DeviceDetails.es6');

var _modulesDeviceDetailsEs62 = _interopRequireDefault(_modulesDeviceDetailsEs6);

var app = new _modulesMainEs62['default'](_libJquery1112Min2['default'], [_modulesLoginEs62['default'], _modulesAccountDetailsEs62['default'], _modulesLocationDetailsEs62['default'], _modulesDeviceDetailsEs62['default']], _libJquery1112Min2['default']('[data-module]'), _modulesUtilsEs62['default']);

app.init();

},{"./lib/jquery-1.11.2.min":2,"./modules/AccountDetails.es6":4,"./modules/DeviceDetails.es6":5,"./modules/LocationDetails.es6":6,"./modules/Login.es6":7,"./modules/Main.es6":8,"./modules/Utils.es6":9}],2:[function(require,module,exports){
...
(function (t) {
  function x() {
    for (var a = 0; a < h.length; a++) h[a][0](h[a][1]);h = [];m = !1;
  }function n(a, b) {
    h.push([a, b]);m || (m = !0, y(x, 0));
  }function z(a, b) {
    function c(a) {
      p(b, a);
    }function e(a) {
    ...
    var b = a.owner,
        c = b.state_,
        b = b.data_,
        e = a[c];a = a.then;if ("function" === typeof e) {
      c = l;try {
        b = e(b);
      } catch (d) {
        k(a, d);
      }
    }u(a, b) || (c === l && p(a, b), c === r && k(a, b));
  }function u(a, b) {
    var c;try {
      if (a === b) throw new TypeError("A promises callback cannot return that same promise.");if (b && ("function" === typeof b || "object" === typeof b)) {
        var e = b.then;if ("function" === typeof e) return (e.call(b, function (d) {
          c || (c = !0, b !== d ? p(a, d) : v(a, d));
        }, function (b) {
          c || (c = !0, k(a, b));
        }), !0);
      }
    ...
    a.state_ === s && (a.state_ = w, a.data_ = b, n(A, a));
  }function k(a, b) {
    a.state_ === s && (a.state_ = w, a.data_ = b, n(B, a));
  }function A(a) {
    a.state_ = l;a.then_ = a.then_.forEach(q);
  }function B(a) {
    a.state_ = r;a.then_ = a.then_.forEach(q);
  }function f(a) {
    if ("function" !== typeof a) throw new TypeError("Promise constructor takes a function argument");
    if (!1 === this instanceof f) throw new TypeError("Failed to construct 'Promise': Please use the 'new' operator, this object constructor cannot be called as a function.");this.then_ = [];z(a, this);
  }var g = t.Promise,
      C = g && "resolve" in g && "reject" in g && "all" in g && "race" in g && (function () {
    var a;new g(function (b) {
      a = b;
    });return "function" === typeof a;
  })();"undefined" !== typeof exports && exports ? exports.Promise = f || g : C || (t.Promise = f);var s = "pending",
      w = "sealed",
      l = "fulfilled",
      r = "rejected",
      D = function D() {},
      ...
      h = [],
      m;f.prototype = { constructor: f, state_: s, then_: null, data_: void 0, then: function then(a, b) {
      var c = { owner: this, then: new this.constructor(D), fulfilled: a, rejected: b };this.state_ === l || this.state_ === r ? n(q, c) : this.then_.push(c);return c.then;
    }, "catch": function _catch(a) {
      return this.then(null, a);
    } };f.all = function (a) {
    if (!Array.isArray(a)) throw new TypeError("You must pass an array to Promise.all().");return new this(function (b, c) {
      function e(a) {
        f++;return function (c) {
          d[a] = c;--f || b(d);
        };
      }for (var d = [], f = 0, g = 0, h; g < a.length; g++) (h = a[g]) && "function" === typeof h.then ? h.then(e(g), c) : d[g] = h;f || b(d);
    });
  };f.race = function (a) {
    if (!Array.isArray(a)) throw new TypeError("You must pass an array to Promise.race().");return new this(function (b, c) {
...
var _libPromiseMin = require('./../lib/promise.min');
...
var Utils = (function () {
  function Utils() {
    ...
    this.loadUrl = function (url, method, params, json, callback) {
      return new _libPromiseMin2['default'].Promise(function (resolve, reject) {
  ...
  _createClass(Utils, [{
    key: 'loadUrl',
    value: function loadUrl(url, method, params, json, callback) {
      this.loadUrl(url, method, params, json, callback);
    }
  }, {
    key: 'loadScript',
